                            ...
                            <div className="tmp-slider-item-banner-text">
                              <div className="item">
                                <p>
                                  ...
                                  Digital Experiences 🎨 | Let's Build Something
                                  Amazing! 🚀
                                </p>
                              </div>
                              <div className="item">
                                <p>
                                  Available for Hire | Crafting Stunning Digital
                                  Experiences 🎨 | Let's Build Something
                                  Amazing! 🚀
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="banner-personal-portfolio tmponhover paralax-image tmp-card-body with-bento-about-banner tmp-profile-card position-relative mb--30 pb--50 pt_md--0 pt_sm--0">
                          <div className="section-header">
                            ...
                            <p className="">
                              ...
                              and code beautifully simple things and i love what
                              i do. Just simple like that! I design and code
                              beautifully.
                            </p>
                          </div>
