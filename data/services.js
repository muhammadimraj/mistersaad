...
export const serviceCardsExtra = [
  {
    number: "04.",
    title: "Ui/visual Design",
    description:
      "I’m proud of what I’ve accomplished and excited to share my journey with you. I’m proud of what I’ve accomplished.",
  },
  {
    number: "05.",
...
export const serviceCards2 = [
  {
    iconClass: "fa-light fa-pen-ruler",
    title: "Web Design",
    link: "#",
  ...
  {
    iconClass: "fa-light fa-bezier-curve",
    title: "Ui/Ux Design",
    link: "#",
...
export const serviceCardsV2 = [
  {
    num: "01.",
    title: "A Portfolio of Creativity",
    para: "Business consulting consultants provide expert advice and guida the a businesses to help theme their performance efficiency",
    active: true,
    animationOrder: 1,
  },
  {
    ...
    para: "My work is driven by the belief that thoughtful design and strategic planning can empower brands, transform businesses",
    active: false,
    animationOrder: 2,
  },
  {
    ...
    para: "In this portfolio, you’ll find a curated selection of projects that highlight my skills in [Main Areas, e.g., responsive web design",
    active: false,
    animationOrder: 3,
  },
];

export const serviceCardsV3 = [
  {
    num: "01.",
    title: "A Portfolio of Creativity",
    para: "Business consulting consultants provide expert advice and guida the a businesses to help theme their performance efficiency",
    lightClass: "light-top-left",
    animationOrder: 1,
  },
  {
    num: "02.",
...
export const services2 = [
  {
    alt: "ui-ux",
    src: "/assets/images/icons/ui-ux.svg",
    width: 64,
    height: 64,
    title: "UI UX Design",
  },
  ...
  {
    alt: "prd-design",
    src: "/assets/images/icons/prd-design.svg",
    width: 64,
    height: 64,
...
export const misterSaadServices = [
  {
    iconClass: "fa-brands fa-apple",
    title: "iOS Application",
    description: "Get full iOS app development services to create intuitive Apple apps.",
  },
  {
    iconClass: "fa-solid fa-users",
    title: "Users Dashboard",
    description: "Get access to the user's dashboard to update the content on your app.",
  },
  {
    iconClass: "fa-brands fa-android",
    title: "Android Application",
    description: "Develop Android apps for enterprises using the latest technologies.",
  },
  {
    iconClass: "fa-solid fa-location-dot",
    title: "Location Tracking",
    description: "Integrate a location tracking feature perfectly into different apps.",
  },
  {
    iconClass: "fa-solid fa-lightbulb",
    title: "Consulting and Strategy",
    description: "Best app developers in Dubai begins a project to design a mobile application with a detailed meeting with the customer.",
  },
  {
    iconClass: "fa-solid fa-palette",
    title: "UI/UX Design",
    description: "Expert UI/UX designers for your mobile app development process to produce distinctive, gorgeous user interfaces.",
  },
];
